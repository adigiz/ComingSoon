...
const IndexPage = () => (
  <Layout title="Kreatale Coming Soon">
    <img
    ...
    <div className="relative z-10 py-6 space-y-16 lg:space-y-32 text-gray-900">
      <div className="text-center space-y-10">
        ...
        <h1 className="text-7xl lg:text-9xl font-extrabold">We’r on our way</h1>
        <p className="text-xl lg:text-2xl tracking-wide mx-10 lg:max-w-xl lg:mx-auto">
          We`re creating something awesome. Check back for an update soon. Stay in
          touch!
        </p>
      </div>
    </div>
    <div className="absolute bottom-5">
      <ul className="flex space-x-3">
        <li>
          <Link
            href="https://instagram.com/kreatale"
